...
void MakeDistinctPairs(Node*& headPtr)
{
   ...
   while(lookingFor->link != 0)
   {
      while (cursor->link != 0)
      {
         if (lookingFor->data != cursor->data)
         {
           precursor = cursor;
           cursor = cursor->link;
         ...
         if (lookingFor->data == cursor->data && found == false)
         {
            precursor->link = cursor->link;
            cursor->link = lookingFor->link;
            lookingFor->link = cursor;
            found = true;
         ...
         if (lookingFor->data == cursor->data && found == true)
         {
            precursor->link = cursor->link;
            delete cursor;
      ...
      {
         Node *newNode = new Node;
         newNode->data = lookingFor->data;
         newNode->link = lookingFor->link;
         lookingFor = lookingFor->link;
         cursor = lookingFor->link;
         precursor = lookingFor;
